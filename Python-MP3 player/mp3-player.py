...
menubar = Menu(root)    # Creating the menubar
root.config(menu=menubar)



subMenu = Menu(menubar, tearoff=0)  # Creating the submenu
...
def about_us():
    tkinter.messagebox.showinfo('Music Player', 'This is a music player build using Python Tkinter')
...
lengthlabel = ttk.Label(topframe, text='Duration : --:--')
...
def play_music():
    ...
    if paused:
        ...
        try:
            ...
            tkinter.messagebox.showerror('Error in Playing', 'Either file doesnot exist or not a mp3 extension.')
